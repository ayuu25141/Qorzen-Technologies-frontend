...
const Footer = () => {
const handlemail = ()=>{
  const mail = "ayushchauhan753753@gmail.com"
  const subject  = "Hello developer contact"
      const body = "Hello, I want to enroll in the course.";
  ...
  return <footer  className="bg-white mt-10 text-black">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div className="space-y-4">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="text-2xl font-semibold text-blue-400 dark:text-teal-400">
              QorZen Technologies
            </h3>
          </div>
          <p className="text-gray-800 dark:text-gray-800 text-sm leading-relaxed">
          ...
          <div className="flex space-x-5 pt-2">
            <a href="#" className="text-gray-800 hover:text-blue-600 dark:text-gray-400 dark:hover:text-teal-400 transition-transform transform hover:scale-110">
              <GitHubIcon size={28} />
            </a>
            <a href="#" className="text-gray-800 hover:text-blue-600 dark:text-gray-400 dark:hover:text-teal-400 transition-transform transform hover:scale-110">
              <TwitterIcon size={28} />
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3">
            <li>
              <a href="/" className="text-gray-800 text-gray-800 dark:text-gray-800 hover:text-blue-600 dark:hover:text-teal-400 transition-colors duration-300">
                Home
              </a>
            </li>
            <li>
      ...
      document.getElementById("about")?.scrollIntoView({
    ...
    }}  className="text-gray-8000 dark:text-gray-800 hover:text-blue-600 dark:hover:text-teal-400 transition-colors duration-300">
                About Us
              </a>
            </li>
            <li>
              ...
              }} className="text-gray-800 dark:text-gray-800 hover:text-blue-600 dark:hover:text-teal-400 transition-colors duration-300">
                Services
              </a>
            </li>
            <li>
              <a href="https://ayushdevx.vercel.app" className="text-gray-800 dark:text-gray-800 hover:text-blue-600 dark:hover:text-teal-400 transition-colors duration-300">
             Developer Portfolio
              </a>
            </li>
            <li>
              <a href="#" className="text-gray-800 dark:text-gray-800 hover:text-blue-600 dark:hover:text-teal-400 transition-colors duration-300">
                Blog
              </a>
            </li>
          </ul>
        ...
        <div className="space-y-4">
          ...
          <p onClick={handlemail} className="text-gray-800 dark:text-gray-800">
      ...
      <div className="text-center text-gray-500 dark:text-gray-400 text-sm pt-10 mt-10 border-t border-gray-200 dark:border-gray-700">
        ...
        <p className="mt-1">
          Designed with <span className="text-red-500">&hearts;</span> by AyushDev100x
        </p>
      </div>
    </footer>;
};
